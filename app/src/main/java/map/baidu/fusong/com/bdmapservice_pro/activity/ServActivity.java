package map.baidu.fusong.com.bdmapservice_pro.activity;
...
import map.baidu.fusong.com.bdmapservice_pro.R;
import map.baidu.fusong.com.bdmapservice_pro.app.ServApp;
...
public class ServActivity extends AppCompatActivity {
    ...
    private LocalServManager locationService;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        locationService = ((ServApp) getApplication()).locationService;
    }
    ...
    protected void onStop() {
        ...
        locationService.stopLocation(); //停止定位服务
        super.onStop();
    }
